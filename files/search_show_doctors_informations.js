...
function get_details(){
    ...
    xhr.onload = function () {
        ...
        // week_days= explode(",",resp[7]);
        // document.getElementById("doctor_name").innerText = resp[7][0];
        // var resp = JSON.parse(this.responseText);
        show_details(resp[0],resp[1],resp[2],resp[3],resp[4],resp[5],resp[6],resp[7],resp[8]);
...
function show_details(name,spec,number,online_pay,exp_y,address,phone,first_turn,week_days) {
